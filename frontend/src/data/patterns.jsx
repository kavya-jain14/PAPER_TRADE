...
export const patternsData = [
  ...
  // ================= 📚 MARKET EDUCATION GUIDE =================
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full" fill="none">
        <text x="50" y="45" textAnchor="middle" fontSize="32" fill="#D4A574">📖</text>
        <text x="50" y="70" textAnchor="middle" fontSize="10" fill="#D4A574" fontWeight="bold">LEARN</text>
      </svg>
    )
  },
  ...
  // ================= 🕯️ DOJI CANDLE FAMILY =================
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-[0_0_8px_rgba(234,179,8,0.5)]">
        <line x1="50" y1="10" x2="50" y2="90" stroke="#D4A574" strokeWidth="4" strokeLinecap="round" />
        <line x1="30" y1="50" x2="70" y2="50" stroke="#D4A574" strokeWidth="6" strokeLinecap="round" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-[0_0_8px_rgba(255,59,48,0.4)]">
        <line x1="50" y1="10" x2="50" y2="90" stroke="#EF4444" strokeWidth="4" strokeLinecap="round" />
        <line x1="35" y1="90" x2="65" y2="90" stroke="#EF4444" strokeWidth="6" strokeLinecap="round" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-[0_0_8px_rgba(234,179,8,0.3)]">
        <line x1="50" y1="5" x2="50" y2="95" stroke="#D4A574" strokeWidth="4" strokeLinecap="round" />
        <line x1="32" y1="50" x2="68" y2="50" stroke="#D4A574" strokeWidth="6" strokeLinecap="round" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <line x1="50" y1="10" x2="50" y2="90" stroke="#D4A574" strokeWidth="4" strokeLinecap="round" />
        <rect x="40" y="42" width="20" height="16" fill="#D4A574" rx="3" />
      </svg>
    )
  },
  ...
  // ================= 🟢 SINGLE CANDLE BULLISH =================
  {
    ...
    color: "text-[#4ADE80]", bg: "bg-[#4ADE80]/10", border: "border-[#4ADE80]/20",
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]">
        <line x1="50" y1="20" x2="50" y2="90" stroke="#4ADE80" strokeWidth="4" strokeLinecap="round" />
        <rect x="40" y="20" width="20" height="25" fill="#4ADE80" rx="4" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]">
        <line x1="50" y1="20" x2="50" y2="80" stroke="#4ADE80" strokeWidth="4" strokeLinecap="round" />
        <rect x="40" y="65" width="20" height="15" fill="#4ADE80" rx="4" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-[0_0_8px_rgba(255,255,255,0.4)]">
        <line x1="50" y1="15" x2="50" y2="85" stroke="#4ADE80" strokeWidth="4" strokeLinecap="round" />
        <line x1="35" y1="15" x2="65" y2="15" stroke="#4ADE80" strokeWidth="6" strokeLinecap="round" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        <rect x="40" y="20" width="20" height="70" fill="#4ADE80" rx="2" />
      </svg>
    )
  },
  ...
  // ================= 🟢 DOUBLE CANDLE BULLISH =================
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <line x1="30" y1="40" x2="30" y2="70" stroke="#EF4444" strokeWidth="4" />
        <rect x="22" y="45" width="16" height="20" fill="#EF4444" rx="2" />
        <line x1="70" y1="20" x2="70" y2="90" stroke="#4ADE80" strokeWidth="4" />
        <rect x="62" y="25" width="16" height="60" fill="#4ADE80" rx="2" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <line x1="30" y1="10" x2="30" y2="80" stroke="#EF4444" strokeWidth="4" />
        <rect x="22" y="15" width="16" height="60" fill="#EF4444" rx="2" />
        <line x1="70" y1="30" x2="70" y2="90" stroke="#4ADE80" strokeWidth="4" />
        <rect x="62" y="40" width="16" height="45" fill="#4ADE80" rx="2" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <line x1="30" y1="10" x2="30" y2="90" stroke="#EF4444" strokeWidth="4" />
        <rect x="22" y="20" width="16" height="60" fill="#EF4444" rx="2" />
        <line x1="70" y1="40" x2="70" y2="60" stroke="#4ADE80" strokeWidth="4" />
        <rect x="62" y="45" width="16" height="10" fill="#4ADE80" rx="2" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <rect x="22" y="55" width="16" height="30" fill="#EF4444" rx="2" />
        <rect x="62" y="15" width="16" height="35" fill="#4ADE80" rx="2" />
      </svg>
    )
  },
  ...
  // ================= 🟢 TRIPLE+ CANDLE BULLISH =================
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <rect x="15" y="20" width="16" height="40" fill="#EF4444" rx="2" />
        <rect x="42" y="65" width="16" height="10" fill="#bbcbb2" rx="2" />
        <rect x="69" y="30" width="16" height="35" fill="#4ADE80" rx="2" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <rect x="15" y="60" width="16" height="30" fill="#4ADE80" rx="2" />
        <rect x="42" y="40" width="16" height="30" fill="#4ADE80" rx="2" />
        <rect x="69" y="20" width="16" height="30" fill="#4ADE80" rx="2" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <rect x="15" y="20" width="16" height="30" fill="#EF4444" rx="2" />
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <rect x="15" y="30" width="16" height="50" fill="#EF4444" rx="2" />
        <rect x="42" y="50" width="16" height="20" fill="#4ADE80" rx="2" />
        <rect x="69" y="15" width="16" height="55" fill="#4ADE80" rx="2" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <rect x="10" y="60" width="12" height="20" fill="#4ADE80" rx="1" />
        <rect x="30" y="40" width="12" height="20" fill="#4ADE80" rx="1" />
        <rect x="50" y="20" width="12" height="20" fill="#4ADE80" rx="1" />
        <rect x="75" y="15" width="14" height="70" fill="#EF4444" rx="1" />
      </svg>
    )
  },
  ...
  // ================= 🔴 SINGLE CANDLE BEARISH =================
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-[0_0_10px_rgba(255,59,48,0.3)]">
        <line x1="50" y1="10" x2="50" y2="80" stroke="#EF4444" strokeWidth="4" strokeLinecap="round" />
        <rect x="40" y="55" width="20" height="25" fill="#EF4444" rx="4" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <line x1="50" y1="20" x2="50" y2="90" stroke="#EF4444" strokeWidth="4" />
        <rect x="40" y="20" width="20" height="25" fill="#EF4444" rx="4" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        ...
        <rect x="40" y="10" width="20" height="70" fill="#EF4444" rx="2" />
      </svg>
    )
  },
  ...
  // ================= 🔴 DOUBLE CANDLE BEARISH =================
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <rect x="22" y="45" width="16" height="20" fill="#4ADE80" rx="2" />
        <rect x="62" y="25" width="16" height="60" fill="#EF4444" rx="2" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <rect x="22" y="40" width="16" height="45" fill="#4ADE80" rx="2" />
        <rect x="62" y="15" width="16" height="50" fill="#EF4444" rx="2" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <line x1="30" y1="20" x2="30" y2="80" stroke="#4ADE80" strokeWidth="4" />
        <rect x="22" y="45" width="16" height="30" fill="#4ADE80" rx="2" />
        <line x1="70" y1="20" x2="70" y2="60" stroke="#EF4444" strokeWidth="4" />
        <rect x="62" y="25" width="16" height="30" fill="#EF4444" rx="2" />
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <rect x="22" y="15" width="16" height="30" fill="#4ADE80" rx="2" />
        <rect x="62" y="60" width="16" height="35" fill="#EF4444" rx="2" />
      </svg>
    )
  },
  ...
  // ================= 🔴 TRIPLE+ CANDLE BEARISH =================
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <rect x="15" y="10" width="16" height="25" fill="#EF4444" rx="2" />
        <rect x="42" y="30" width="16" height="25" fill="#EF4444" rx="2" />
        <rect x="69" y="50" width="16" height="25" fill="#EF4444" rx="2" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <rect x="15" y="40" width="16" height="40" fill="#4ADE80" rx="2" />
        <rect x="42" y="20" width="16" height="10" fill="#bbcbb2" rx="2" />
        <rect x="69" y="35" width="16" height="45" fill="#EF4444" rx="2" />
      </svg>
    )
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full">
        <rect x="15" y="50" width="16" height="30" fill="#4ADE80" rx="2" />
        <rect x="42" y="20" width="16" height="4" fill="#bbcbb2" rx="2" />
        <rect x="69" y="50" width="16" height="30" fill="#EF4444" rx="2" />
      </svg>
    )
  }
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full" fill="none" stroke="#4ADE80" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full" fill="none" stroke="#EF4444" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" className="w-full h-full" fill="none" stroke="#4ADE80" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
        ...
        <line x1="20" y1="20" x2="70" y2="45" stroke="#EF4444" strokeWidth="2" strokeDasharray="2 2" /> {/* Upper bound */}
        <line x1="30" y1="50" x2="80" y2="75" stroke="#4ADE80" strokeWidth="2" strokeDasharray="2 2" /> {/* Lower bound */}
      </svg>
    )
  }
];